...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.convertRGBToHex = exports.convertHexToRGB = undefined;

	var _HexInput = __webpack_require__(2);

	var _HexInput2 = _interopRequireDefault(_HexInput);

	var _RGBInput = __webpack_require__(168);
	...
	function convertHexToRGB(str) {
		...
		if (isValidHex(str)) {
			var twoPartition = function twoPartition(string) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HexInput = function (_React$Component) {
		...
		function HexInput() {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(HexInput).call(this));
		...
		_createClass(HexInput, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					{ className: 'primary-font text-center' },
					_react2.default.createElement(
						'h2',
						null,
						'Hexadecimal'
					),
					_react2.default.createElement('input', { className: 'text-center', type: 'text', onChange: this.changeColour.bind(this) })
				);
			}
		}]);
	...
	_reactDom2.default.render(_react2.default.createElement(HexInput, null), document.getElementById('root'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RGBInput = function (_React$Component) {
		...
		function RGBInput() {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(RGBInput).call(this));
	...
	_reactDom2.default.render(_react2.default.createElement(RGBInput, null), document.getElementById('root'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getOpposite(colour) {
		colour = (0, _converter.convertHexToRGB)(colour);
